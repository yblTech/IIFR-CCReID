...
# res = torch.load("/home/kpn/lyb/prcc-bestcopy/caption/text_int.pt")
# output_file = "/home/kpn/lyb/prcc-bestcopy/caption/tt_int.pt"
# features_with_paths = {}
# print(len(res["tf"]))
# for i  in range(len(res["tf"])):
#     key1 = "tf"+res["image_paths"][i]
#     key2 = "af"+res["image_paths"][i]
#     key3 = "tt"+res["image_paths"][i]
#     features_with_paths[key1]=res["tf"][i]
#     features_with_paths[key2]=res["af"][i]
#     features_with_paths[key3]=res["tt"][i]
